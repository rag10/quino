...
class MechanismAssembler:
    ...
    def assemble(self, project) -> AssembledMechanism:
    ...
    def _assemble_spring(self, project, spring: Spring, bodies: dict) -> AssembledSpring:
    ...
    def _assemble_body(self, project, body: Body) -> AssembledBody:
    ...
    def _assemble_slider(self, project, slider: Slider) -> AssembledSlider:
    ...
    def _eval_marker(self, project, marker: Marker) -> AssembledMarker:
    ...
    def _eval_optional(self, project, prop, default: float | None) -> float | None:
        if prop is None:
            return default
