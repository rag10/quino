...
CONSTRAINT_SPECS: dict[SketchConstraintType, ConstraintSpec] = {
    ...
    SketchConstraintType.HORIZONTAL_DISTANCE: ConstraintSpec(2, 0, Dimension.LENGTH, "length", "Horizontal Distance"),
    SketchConstraintType.VERTICAL_DISTANCE: ConstraintSpec(2, 0, Dimension.LENGTH, "length", "Vertical Distance"),
    SketchConstraintType.RADIUS: ConstraintSpec(1, 1, Dimension.LENGTH, "length", "Radius"),
    ...
    SketchConstraintType.COLLINEAR: ConstraintSpec(4, 0, None, "none", "Collinear"),
